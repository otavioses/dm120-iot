export default class Content {
    ...
    constructor($temperatura: string, $tempMax: string, $tempMin: string, $umidade: string, $umidMax: string, $umidMin: string, 
        $luminosidade: string, $lumMax: string, $lumMin: string, $current_color: string, $status_buzzer: string) {
